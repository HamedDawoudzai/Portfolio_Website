        ...
        <div className="flex items-center gap-3">
          {socialLinks.map((link) => (
            <a
              ...
              className="flex h-9 w-9 items-center justify-center rounded-lg border border-card-border bg-card text-muted transition-all hover:border-accent/40 hover:text-accent hover:scale-110"
            >
              {link.icon}
            </a>
          ))}
